...
(function (app) {
    ...
    app.controller('sendDispatchAwayListController', sendDispatchAwayListController);
    // khởi tạo tự động các đối tượng service , và inject vào trong hàm productCategoryListController
    sendDispatchAwayListController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter'];

    function sendDispatchAwayListController($scope, apiService, notificationService, $ngBootbox, $filter) {
        ...
        function getProduct(page) {
            ...
            //}
            ///api/product/getAll
            apiService.get('http://' + hostlink + ':3000/api/queries/selectDispatchAwaySending', null,
                function (result) {
