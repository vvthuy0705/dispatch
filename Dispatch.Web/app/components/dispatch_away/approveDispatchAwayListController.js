...
(function (app) {
    ...
    app.controller('approveDispatchAwayListController', approveDispatchAwayListController);
    // khởi tạo tự động các đối tượng service , và inject vào trong hàm productCategoryListController
    approveDispatchAwayListController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter'];

    function approveDispatchAwayListController($scope, apiService, notificationService, $ngBootbox, $filter) {
        ...
        function getProduct(page) {
            ...
            //}
            ///api/product/getAll
            apiService.get('http://' + hostlink + ':3000/api/queries/filterDispatchAwayByApprove', null,
                function (result) {
