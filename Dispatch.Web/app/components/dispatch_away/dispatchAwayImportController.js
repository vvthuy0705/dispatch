(function (app) {
    app.controller('productImportController', ['apiService', '$scope', 'notificationService', '$state', '$http', 'authenticationService',
        function (apiService, $scope, notificationService, $state, $http, authenticationService) {
            $scope.files = [];
            $scope.categoryId = 0;
           ...
           function ImportProduct() {
            ...
            this.loadParentCategory = function () {
            ...
            this.recur = function (item, level, arr) {
                arr.push({
