...
(function (app) {
    ...
    app.controller('dispatchAwayListController', dispatchAwayListController);
    // khởi tạo tự động các đối tượng service , và inject vào trong hàm productCategoryListController
    dispatchAwayListController.$inject = ['$scope', 'apiService', 'notificationService', '$ngBootbox', '$filter'];

    function dispatchAwayListController($scope, apiService, notificationService, $ngBootbox, $filter) {
        ...
        function getProduct(page) {
            ...
            //}
            ///api/product/getAll
            apiService.get('http://' + hostlink + ':3000/api/DispatchAway', null,
                function (result) {
